-- ════════════════════════════════════════════════════════════════
--  MIGRATION: Farmer Phone Auth + Profile Update
--  Run this in Supabase SQL Editor (Dashboard → SQL Editor → New Query)
--  
--  What it does:
--    1. Creates farmer_complete_signup() stored procedure
--    2. Creates update_user_profile() stored procedure  
--    3. Creates cleanup_expired_sessions() utility function
--    4. Adds RLS policy for profile inserts (needed for phone auth)
-- ════════════════════════════════════════════════════════════════
